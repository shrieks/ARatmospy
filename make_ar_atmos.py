...
onelfileroot  = rootdir+'ar-atmos1l-'+trim(alpha_mag)+'-'+trim(n)+'-'+stamp
# filnemae root for a multilayer simulation-worthy datacube
arfileroot = rootdir + 'gpi_arf' + '_rate'+trim(round(rate)) + '_exptime'+trim(exptime) + $
             '_amag' + trim(alpha_mag)
...
### make the aperture
generate_grids, ax, ay, bign, scal=pscale
ar        = sqrt(ax^2 + ay^2) ## aperture radius
